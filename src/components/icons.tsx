...
export function RewindIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M11 17a1 1 0 0 1-1.447.894l-6-3a1 1 0 0 1 0-1.788l6-3A1 1 0 0 1 11 11v6z" fill="currentColor" />
      <path d="M21 17a1 1 0 0 1-1.447.894l-6-3a1 1 0 0 1 0-1.788l6-3A1 1 0 0 1 21 11v6z" fill="currentColor" />
    </svg>
  );
}

export function ForwardIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M13 7a1 1 0 0 1 1.447-.894l6 3a1 1 0 0 1 0 1.788l-6 3A1 1 0 0 1 13 13V7z" fill="currentColor" />
      <path d="M3 7a1 1 0 0 1 1.447-.894l6 3a1 1 0 0 1 0 1.788l-6 3A1 1 0 0 1 3 13V7z" fill="currentColor" />
    </svg>
  );
}
